    ...
    <div className="max-w-7xl mx-auto space-y-8 pb-32 px-6">
      ...
      {folder && (
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="glass-card p-4 border-ai-primary/20 bg-ai-primary/5 flex items-center justify-between">
          ...
          <button onClick={handleRegenerateAllImages} disabled={isGeneratingImages} className="px-5 py-2.5 rounded-xl bg-emerald-500 text-white text-[10px] font-bold uppercase tracking-widest hover:brightness-110 shadow-lg shadow-emerald-500/20 transition-all flex items-center gap-2">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
           ...
           <button
            ...
            className="px-10 py-4 rounded-2xl bg-emerald-500 text-white shadow-xl shadow-emerald-500/20 hover:scale-105 transition-all disabled:opacity-50 flex items-center gap-2 font-bold"
          >
