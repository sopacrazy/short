...
export async function uploadToYouTube(videoUrl, title, description, hashtags, language = 'pt', channelTags = [], scheduledAt, userId) {
    if (!userId)
        throw new Error('UserId é necessário para upload');
