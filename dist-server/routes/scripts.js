...
router.post('/', async (req, res) => {
    ...
    const { topic, niche = 'curiosidades', duration_target = 45, voice_tone = 'dramático e envolvente', narration_speed = 'moderado', previous_hook, previous_title, language = 'pt', } = req.body;
    if (!topic)
